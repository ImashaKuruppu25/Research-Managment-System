...
const ViewGroup = () => {
  // const trucate = () => {
  //   if (member1Id.length > 100) {
  //     return member1Id.substring(0, 100) + "...";
  //   } else {
  //     return member1Id;
  //   }
  // };
  ...
  const submitHandler = (event) => {
    ...
    axios
      .patch(`http://localhost:8070/group/updateGrpup/${id}`, data)
      .then((res) => {
        setNotify({
          isOpen: true,
          ...
          >
            ...
            <div className="userShowBottom">
              ...
              <div className="userShowTop">
                ...
                />
                <div className="userShowTopTitle">
                  <span className="userShowUsername">{member2Id.name}</span>
              ...
              <div className="userShowTop">
                ...
                />
                <div className="userShowTopTitle">
                  <span className="userShowUsername">{member3Id.name}</span>
              ...
              <div className="userShowTop">
                ...
                />
                <div className="userShowTopTitle">
                  <span className="userShowUsername">{member4Id.name}</span>
